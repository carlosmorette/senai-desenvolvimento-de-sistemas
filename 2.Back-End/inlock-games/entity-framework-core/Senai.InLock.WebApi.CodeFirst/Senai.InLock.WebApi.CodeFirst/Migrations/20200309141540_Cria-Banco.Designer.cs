...
namespace Senai.InLock.WebApi.CodeFirst.Migrations
{
    ...
    [Migration("20200309141540_Cria-Banco")]
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Estudios", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { IdEstudio = 2, NomeEstudio = "Rockstart Studios" },
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Jogos", b =>
                {
                    ...
                    b.HasData(
                        new { IdJogo = 1, DataLancamento = new DateTime(2012, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "Descrição do Diablo 3", IdEstudio = 1, NomeJogo = "Diablo3", Valor = 55.00m },
                        new { IdJogo = 2, DataLancamento = new DateTime(2018, 10, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "Descrição d RDR II", IdEstudio = 2, NomeJogo = "Red Dead Redemption II", Valor = 120.00m }
                    );
                });
